...
13. 8 BIllion cant
14. 1 Token is not a word
15. A token can be a SubWord
16. A token can be a multi word
17. A token can be a single char
18. Tokens are present in a dictionary called Vocabulary
19. This is frozen
20. 
